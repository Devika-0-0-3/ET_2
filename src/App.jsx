    ...
    <div className="bg-white text-black">
      ...
      <main className="min-h-[70vh] flex flex-col items-center justify-center">
        <div className="max-w-4xl text-center px-4">
          <h1 className="text-5xl font-bold">Welcome to Transparent</h1>
          <p className="mt-4 text-lg">Your trusted platform for sales communication and analytics.</p>
        </div>
      </main>

   
      <footer className="bg-[#160828] text-white pt-10 pb-5 px-4">
